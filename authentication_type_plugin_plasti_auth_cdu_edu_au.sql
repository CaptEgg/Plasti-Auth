...
': consectetur adipiscing elit. <a href="about:blank">Lorum Ispsum Linksum</a></span>''||chr(10)||'||unistr('\000a')||
''' </div>''||chr(10)||'||unistr('\000a')||
...
'is'||unistr('\000a')||
'  l_session_recycle   va'||
'rchar2(1) := p_authentication.attribute_02;'||unistr('\000a')||
...
'  l_query_string      v'||
'archar2(32767) := null;'||unistr('\000a')||
...
'  and l_session_recycle = ''Y'' and l_whitelist is not null'||unistr('\000a')||
...
'    if '||
'l_cookie_session_id is not null then'||unistr('\000a')||
''||unistr('\000a')||
'      -- Validate cookie session and get username'||unistr('\000a')||
'      begin'||unistr('\000a')||
'        select user_name'||unistr('\000a')||
...
''||unistr('\000a')||
'      if'||
' l_result.is_valid then'||unistr('\000a')||
'        '||unistr('\000a')||
...
'        if l_confirmation is not null then'||unistr('\000a')||
'          --'||
...
'          WWV_FLOW_UTILITIES.PARSE_QUERY_STRING(l_query_string,l_app,l_page,l_session,l_tail); '||unistr('\000a')||
'          '||unistr('\000a')||
'          -- Clear REQUEST to reduce risk of DML via external links'||unistr('\000a')||
'          l_tail := regexp_replace(l_tail,''^[^:]+'');'||unistr('\000a')||
'  '||
'        '||unistr('\000a')||
'          select application_name'||unistr('\000a')||
'          into l_app_name'||unistr('\000a')||
...
'is'||unistr('\000a')||
'  l_auth_func   varchar2(255) := p_'||
'authentication.attribute_01;'||unistr('\000a')||
...
'    raise_application_error(-20001,''Authentication Plugin: authentication function must be of the format "Func'||
'tion_Name(p_username varchar2, p_password varchar2) return boolean"'');'||unistr('\000a')||
'  else'||unistr('\000a')||
